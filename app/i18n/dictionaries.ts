...
const it = {
  ...
  hero: {
    badge: "Ora disponibile su App Store",
  ...
  free: {
    ...
    lede: "Nessun abbonamento, nessuna versione premium, nessuna funzione bloccata. Se ti va di sostenere il progetto, offrimi un caffè.",
...
const en: typeof it = {
  ...
  search: {
    ...
    cta: "Discover recurring entries",
  },
  features: {
  ...
  free: {
    price: "€4.99 / month",
    title: "Free. Forever.",
    lede: "No subscription, no premium tier, no locked features. If you'd like to support the project, buy me a coffee.",
